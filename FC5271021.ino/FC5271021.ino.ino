...
#define SEALEVELPRESSURE_HPA (1030) // Pressure at sea level is set at 1013.25Pa
...
unsigned long previousMillis = 0;    // will store last time system time is updated
unsigned long currentMillis = millis();   //check system up time
const long blink = 500;             // interval at which to blink (milliseconds)
...
/***************************************************************************/
//Must get 3 reading lower than the last reading in a row to be considered apogee, then deploy parachute by actuating servo
void apogeeCheck() {
